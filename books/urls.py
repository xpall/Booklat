...
urlpatterns = [
    ...
    path("categories/<int:category_id>/edit/", views.category_update_view, name="category_edit"),
    path("categories/<int:category_id>/archive/", views.category_archive_view, name="category_archive"),
    path("categories/<int:category_id>/unarchive/", views.category_unarchive_view, name="category_unarchive"),
